          ...
          <div class="training-programma">
            ...
            <div class="text-column">
                <div class="event-journey-description">
                    Почему магазины должны меняться
                    <ul class="event-journey-bullets">
                        <li>На сцене – новый покупатель</li>
                        <li>Новые тренды покупательского поведения</li>
                        <li>Новые форматы фэшн магазинов</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    Эффективный торговый концепт
                    <ul class="event-journey-bullets">
                        <li>«Золотые правила» планировки </li>
                        <li>Оптимальная вместимость магазина/ формула расчета</li>
                        <li>Корректировка вместимости под задачи</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    ...
                    <ul class="event-journey-bullets">
                        ...
                        <li>Зонирование в распродажу</li>
                        <li>Оптимизация зонирования и ротация коллекций</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    Торговое оборудование
                    <ul class="event-journey-bullets">
                        <li>Критерии эффективности </li>
                        <li>Оборудование «под бренд»/ новые тренды</li>
                        <li>Расстановка оборудования и рутинг</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    Магазин – магнит для покупателей
                    <ul class="event-journey-bullets">
                        <li>Входное пространство-магнит</li>
                        <li>Зоны «Активных продаж»</li>
                        <li>Новые способы навигации</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    Дизайн-концепция магазина
                    <ul class="event-journey-bullets">
                        ...
                        <li>Взаимодействие с подсознанием покупателя</li>
                        <li>Как найти уникальный почерк бренда</li>
                    </ul>
                </div>
            </div>
          </div>
