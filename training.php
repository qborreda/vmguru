...
<body class="tmpl-trainings">
    ...
    <div class="short_wrapper">
        ...
        <section class="new-section">
          ...
          <div class="section-intro-text">
              <p>Oбучение в формате интерактивного тренинга с Блиц консалтингом участников.</p>
              <p>В тренинги добавлены ВМ инструменты, усиливающие продажи в кризис. Антикризисные скидки.</p>
          </div>
        </section>
          ...
          <div class="trainer">
              ...
              <div class="trainer-resume">
                ...
                <div class="about-anna">
                    <p>Сегодня покупатели хотят не просто прийти в магазин за новой покупкой, они хотят получить эмоции, зарядиться атмосферой и найти свой товар на уровне подсознания.</p>
                    <p>Все это может обеспечить грамотная организация торгового пространства и презентация в нем товара, а также созданный «под бренд» и его покупателей дизайн магазина.</p>
