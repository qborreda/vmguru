      ...
      <section class="hero_section">
          <div class="hero_image vm">
            <div class="hero_contents">
              <div class="hero_dates">28 февраль - 1 марта</div>
            ...
            <div class="text-column">
                ...
                <div class="event-journey-description">
                    ...
                    <ul class="event-journey-bullets">
                        ...
                        <li>Правила презентации трендовых, цветовых и промо мини коллекций </li>
                        <li>Особенности презентации моделей Сезонных Хитов, Вольюм Драйверов, Слоу Муверов, KVI моделей</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    ...
                    <ul class="event-journey-bullets">
                        ...
                        <li>Оптимизация презентации товара: действия в ситуациях “то густо, то пусто”</li>
                    </ul>
                </div>
                <div class="event-journey-description">
