      ...
      <section class="hero_section">
          <div class="hero_image vm">
            <div class="hero_contents">
              <div class="hero_dates">26-27 марта</div>
            ...
            <div class="text-column">
                ...
                <div class="event-journey-description">
                    ...
                    <ul class="event-journey-bullets">
                      ...
                      <li>Оптимальная вместимость торгового зала</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    Презентация коллекций в торговом зале
                    <ul class="event-journey-bullets">
                        <li>Правила презентации трендовых, цветовых и промо коллекций </li>
                        <li>Особенности презентации  Хитов, Слоу Муверов, KVI моделей</li>
                        <li>Презентация на разном торговом оборудовании</li>
                        <li>Действия в ситуациях “то густо, то пусто”</li>
                    </ul>
                </div>
                <div class="event-journey-description">
                    Зонирование и размещение коллекций /работа с планограммами
                    <ul class="event-journey-bullets">
                        <li>Мобильное зонирование</li>
                        <li>Температурная карта зон магазина</li>
                        <li>Способы «утепления» зон</li>
                        <li>Зоны «Активных продаж» - работа с подсознанием покупателя</li>
                        <li>Расстановка оборудования, рутинг </li>
                    </ul>
                </div>
                <div class="event-journey-description">
                ...
                <div class="event-journey-description">
                    Система управления ВМ сетевого бренда
                    <ul class="event-journey-bullets">
                        <li>Система Модел Стор - алгоритм работы и пошаговое внедрение</li>
                        <li>Западные технологии дистанционного ВМ</li>
                    </ul>
                </div>
            </div>
          </div>
