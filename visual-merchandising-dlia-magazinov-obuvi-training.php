    ...
    <section class="hero_section">
      <div class="hero_image shoes">
        <div class="hero_contents">
          ...
          <div class="hero_dates">25 сентября</div>
          ...
          <p class="hero_description">
            ...
            <br />Как грамотно зонировать коллекции для max продаж
            <br />Как выделить ФСГ и сделать ключевые модели драйверами продаж
            <br />Как создать эффективное торговое пространство и витрины без доп. затрат
            <br />Где зоны роста и что изменить именно в вашем магазине
  ...
  <div class="short_wrapper">
      ...
      <div class="more-info">
        <div class="more-info-left">
          ...
          <ul class="info-bullets">
            ...
            <li>руководители и специалисты отделов визуальный мерчандайзинг</li>
          </ul>
        </div>
        <div class="more-info-right">
          ...
          <ul class="info-bullets">
            <li>день 1 – теория и Блиц консалтинг</li>
    ...
    <section class="new-section">
      ...
      <div class="training-programma">
        ...
        <div class="text-column">
          <div class="event-journey-description">
            Базовые законы ВМ для магазинов обуви и аксессуаров
          </div>
          <div class="event-journey-description">
            Коммерческие правила выкладки товара
          ...
          <div class="event-journey-description">
            Визуальный мерчандайзинг как зона роста
            <ul class="event-journey-bullets">
              <li>Инструменты зонирования, увеличивающие товарооборот с м2</li>
              <li>Температурная карта торговых зон</li>
              <li>Управление работой торговых зон</li>
              <li>Входное пространство-магнит</li>
              <li>Зоны «Активных продаж» - продаем на уровне подсознания</li>
              <li>Оптимальная вместимость. Формула расчета</li>
              <li>Корректировка вместимости для увеличения продаж</li>
            </ul>
          </div>
          <div class="event-journey-description">
            Продающие витрины в магазинах обуви и аксессуаров
            <ul class="event-journey-bullets">
              <li>Низкобюджетная витринистика; правила и приемы </li>
              <li>Новый язык магазина: Визуальная коммуникация и сторителлинг</li>
              <li>Нейромаркетинг – визуализация эмоций; как затянуть покупателя в магазин</li>
            </ul>
          </div>
          <div class="event-journey-description">
            Презентация коллекций и оформление витрин в периоды распродаж
          </div>
          <div class="event-journey-description">
            Антикризисный визуальный мерчандайзинг
            <ul class="event-journey-bullets">
              <li>Как и какие модели могут стать драйверами продаж всей коллекции в период спада продаж; особенности
                презентации</li>
      ...
      <div class="training-programma">
        ...
        <div class="text-column">
          <div class="event-journey-description">
            Краткая консультация участников семинара по их вопросам в области визуального мерчандайзинга и планировки
            торгового пространства магазина/ проходит в открытом режиме перед всей аудиторией
            <p><br />Для участия в Блиц консалтинге необходимо:
              <br />Сформулировать вопросы максимально конкретно.</p>
            <p>Подготовить материал для иллюстрации вопросов в виде фото-отчета либо планограммы магазина на электронном
              носителе</p>
          </div>
        </div>
      </div>
    ...
    <section class="new-section">
      ...
      <div class="testimonial">
        <div class="testimonial-intro-text">
          <p>Я прослушал два тренинга Анны: "Визуальный мерчандайзинг для магазинов обуви и аксессуаров" и "Создание
            эффективного магазина".</p>
        </div>
        <div class="testimonial-full-text js-toggle-content js-toggle-01">
          <p>Программы очень полезны владельцам бизнеса, рекомендую. Мне они дали комплекс современных ВМ знаний и
            мощный толчок для изменений в бренде.</p>
          <p>Мы продолжаем сотрудничество. Команда VM Guru разработала для Promenade брендинг-проект, два дизайн-проекта
            и курирует все новые открытия и обучение персонала.</p>
      ...
      <div class="testimonial">
        <div class="testimonial-intro-text">
          <p>Я познакомилась с Анной Баландиной на MOСШУЗ, где Анна проводила семинар для обувных компаний и
            договорились о сотрудничестве - обучении ключевых сотрудников.</p>
        </div>
        <div class="testimonial-full-text js-toggle-content js-toggle-02">
          <p>Предварительно Анна с коллегами провели аудит флагманского магазина Vera Victoria Vito и согласовали с нами
            формат и программу обучения. Первый день был полностью посвящен теории, с примерами на слайдах и обзорами
            успешного опыта сильных брендов и разбором ошибок реальных магазинов. Второй день – практический, Анна
            провела в магазине Vera Victoria Vito на Покровке 11.</p>
          <p>Магазин преобразился полностью! Были переделены зоны для товаров свежей коллекции, расставлены цветовые
            акценты, добавлены аксессуары, удачно дополняющие друг друга, появилась... легкость. Сотрудников научились
            формировать зоны магазина с учетом аналитики продаж, группировать товар, работать с комплементарным товаром,
            создавать «семьи товара».</p>
      ...
      <div class="testimonial">
        <div class="testimonial-intro-text">
          <p>На основе полученных в ходе тренинга знаний, мы начали работу по разработке индивидуальных стандартов
            выкладки коллекций и правильному зонированию магазинов сети.</p>
        </div>
        <div class="testimonial-full-text js-toggle-content js-toggle-03">
          <p>Обучение помогло нам справиться со сложной задачей: нам удалось найти нестандартные и интересные решения
            для выкладки некоторых моделей, а также более компактно и логично выставить большой объем обуви и сумок в
            магазинах.</p>
          <p>Крайне полезна для нас была и теория, и практика по оформлению коммерческой привлекательной витрины,
            внедряем теперь в свои магазины.</p>
          <p>Спасибо Анне Баландиной за хорошо структурированный, доступный для понимания и внедрения материал и
            эффективную практику в магазине.</p>
        </div>
        <div class="testimonial-footer">
          <div class="testimonial-author">
            Азаркевич Ольга,
      ...
      <div class="testimonial">
        <div class="testimonial-intro-text">
          <p>Тренинг проходил в режиме идеального баланса теоретической информации и практики в салонах с возможностью
            задать свои вопросы и получить ответы на них тут же в формате прямого диалога.</p>
        </div>
        <div class="testimonial-full-text js-toggle-content js-toggle-04">
          <p>Анна делилась огромным количеством актуальной информации. Все инструменты адоптированы для обувной розницы,
            это было объяснено и продемонстрировано на нашем ассортименте. Не было сложных для понимания алгоритмов,
            матриц, неизвестной терминологии, которые нереально применить в торговых точках.</p>
          <p>В части вопросов утвердились по результатам тренинга. Новое: нейромаркетинг, возможность использовать
            инструменты фэшн-магазинов в практику специализированных ортопедических салонов.</p>
          <p>Тренинг стал практически пошаговой инструкцией, которую мы смогли применить сразу же после его окончания,
            разработав и внедрив новый стандарт мерчандайзинга ортопедической обуви. Планируем и дальше использовать
            полученную информацию для перепланировки салонов, изменения выкладки товаров и изменения торгового обувного
            оборудования.</p>
          <a href="/projects/project-medi.php" class="no-border">
            <div class="cta-button">
              показать проект ›
            </div>
          </a>
        ...
        <div class="testimonial-footer">
          <div class="testimonial-author">
            Григорьева Марина,
            <div class="testimonial-title">Руководитель отдела управления ассортиментом
              <br />Mediexp, Cеть ортопедических салонов Medi</div>
          </div>
      ...
      <div class="testimonial">
        <div class="testimonial-intro-text">
          <p>Обучение очень комфортное. Была небольшая группа, в любой момент разбирались все вопросы. Когда мне
            предложили пройти тренинг в онлайн формате, я боялась, как без личного присутствия удастся усвоить материал,
            но оказывается, всё очень доступно, удобно, легко. При этом сокращается время на дорогу, парковку,
      ...
      <div class="testimonial">
        <div class="testimonial-intro-text">
          <p>Мне очень все понравилось! Я всё для себя разъяснила, пояснила, потому что информации профессиональной по
            обувному мерчандайзингу очень мало даже в одежде больше. Мне понравилось всё, очень полезно и самый большой
            плюс, что не нужно приезжать. Давно хотела посетить этот тренинг, но сложно было подстроиться под даты
            группы, а тут и информацию ценную получила и много времени на это не затратила. Можно сразу пойти внедрять.
          </p>
        </div>
        <div class="testimonial-full-text js-toggle-content js-toggle-06">
          <p>У меня три магазина, и я сама частично выкладкой занимаюсь. Так что мне был материал понятен и достаточен и
            без практики в магазине.</p>
      ...
      <div class="testimonial">
        ...
        <div class="testimonial-full-text js-toggle-content js-toggle-07">
          <p>На тренинге мы получили много полезной информации, которую не знали, хотя сами занимаемся визуальным
            мерчандайзингом в бренде. Формат комфортный интерактивный, много примеров, разбор планограмм, время
            пролетает быстро и опять же экономия времени на дорогу. Здорово!</p>
          <p>ОНЛАЙН ТРЕНИНГ. Пройден 23.03.2020</p>
        </div>
        <div class="testimonial-footer">
          <div class="testimonial-author">
