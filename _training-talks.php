<section class="trainings-section3">
      ...
      <article class="hex-content clearfix">
          ...
          <div class="hex-content-right">
              ...
              <p class="hex-content-description">
                  ...
                  <br/>КАК ПОДНЯТЬ ПРОДАЖИ В  МАГАЗИНЕ СРЕДСТВАМИ ВИЗУАЛЬНОГО МЕРЧАНДАЙЗИНГА; СОВРЕМЕННЫЕ ТЕХНОЛОГИИ КОММЕРЧЕСКОГО ВМ.
              </p>
              <ul class="hex-content-list">
                <li>Законы коммерческого визуального мерчандайзинга (ВМ) фэшн магазинов</li>
                <li>Эффективное зонирование магазина; оптимизация потенциала торговых зон </li>
                <li>Продажи на подсознательном уровне – как презентовать товар, чтобы покупатель не ушел без покупки;       </li>
                <li>Зоны «Активных продаж» - алгоритм создания</li>
                <li>Эмоциональный мерчандайзинг – тренд, которым «болен европейский рынок». Как использовать «эмоции товарной презентации» для увеличения продаж</li>
                <li>Продающие витрины и эффективное входное пространство магазина -       </li>
                <li>большой эффект без больших расходов. Алгоритмы создания</li>
                <li>Антикризисный визуальный мерчандайзинг - ВМ       быстрого реагирования и малых бюджетов; как это работает      </li>
                <li>Как выстроить систему дистанционного ВМ сетевого бренда</li>
              </ul>
      ...
      <article class="hex-content clearfix">
          ...
          <div class="hex-content-right">
              ...
              <ul class="hex-content-list">
                <li>«Золотые» правила планировки и зонирования магазинов одежды и товаров для детей</li>
                ...
                <li>магазине – двигатель продаж</li>
                <li>как выбрать яркий и индивидуальный стиль оформления детского магазина; мировые тенденции в оформлении фэшн магазинов</li>
              </ul>
      ...
      <article class="hex-content clearfix">
          <div class="hex-content-left">
              ...
              <div class="hex-content-image">
                  <img src="imgs/hex-pill-trainings8.jpg" alt="" />
              </div>
          </div>
          <div class="hex-content-right">
              <p class="hex-content-name">Euro Shoes Collection Premier
              ...
              <p class="hex-content-description">
                  <strong>Семинар Анны Баландиной: </strong>
                  <br/>СЕКРЕТЫ ЭФФЕКТИВНОГО ОБУЧЕНИЯ ВИЗУАЛЬНОМУ МЕРЧАНДАЙЗИНГУ: БЫСТРО – СЕЗОННО – МАКСИМУМ ПРАКТИКИ.
              </p>
              <ul class="hex-content-list">
                <li>Как обучать ВМ: нужно ли «зубрить» теорию и как применять знания на практике «под бренд»</li>
                <li>Что такое дистанционный визуальный мерчандайзинг магазина обуви и аксессуаров и как это работает</li>
                <li>Как коммерчески презентовать коллекции и управлять выкладкой в обувной сети без рядовых мерчандайзеров: визуальный мерчандайзинг без мерчандайзеров - это работает?</li>
                <li>«Продающие витрины» обувных магазинов – как создать эффектные сезонные витрины без больших расходов и транслировать оформление на сеть</li>
              </ul>
      ...
      <article class="hex-content clearfix">
          <div class="hex-content-left">
              <p class="hex-content-name">БРИТАНСКАЯ ВЫСШАЯ ШКОЛА ДИЗАЙНА
              <br/>24 мая 19.00 – 22.00
              </p>
              <div class="hex-content-image">
                  <img src="imgs/hex-pill-trainings9.jpg" alt="" />
              </div>
          </div>
          <div class="hex-content-right">
              <p class="hex-content-name">БРИТАНСКАЯ ВЫСШАЯ ШКОЛА ДИЗАЙНА
              ...
              <p class="hex-content-description">
                  ...
                  <br/>ВИЗУАЛЬНЫЙ МЕРЧАНДАЙЗИНГ КАК ИНСТРУМЕНТ ЭФФЕКТИВНЫХ ПРОДАЖ; КАК ЭТО РАБОТАЕТ?
              </p>
              <!-- <ul class="hex-content-list">
              <li>Законы коммерческого ВМ для магазинов обуви и аксессуаров; как их применять «под бренд» для максимальных продаж.</li>
              <li>Как создать эффективное зонирование магазина, учитывая структуру ассортимента и аналитику сезонных продаж.</li>
              <li>Как работать с торговым пространством: утепление «холодных» зон и максимальное использование потенциала «горячего» торгового пространства для повышения товарооборота.</li>
              <li>Как использовать «эмоции» товарной презентации для увеличения продаж;</li>
              <li>Продающие витрины и эффективное входное пространство магазина; алгоритмы создания</li>
              </ul-->
              <img class="hex-content-logo" src="imgs/logo-british-school-design.png" alt="">
          </div>
      </article>

      <article class="hex-content clearfix">
          <div class="hex-content-left">
              <p class="hex-content-name">ОБУВЬ. МИР КОЖИ-2017. ВЕСНА
              <br/>21 - 24 марта 2017
              <br/>23 марта 13.00-14.00
              </p>
              <div class="hex-content-image">
                  <img src="imgs/hex-pill-trainings5.jpg" alt="" />
              </div>
          </div>
          <div class="hex-content-right">
              <p class="hex-content-name">ОБУВЬ. МИР КОЖИ-2017. ВЕСНА
              ...
              <p class="hex-content-description">
                  <strong>Семинар Анны Баландиной: </strong>
                  <br/>«СОВРЕМЕННЫЕ ТЕХНОЛОГИИ ВИЗУАЛЬНОГО МЕРЧАНДАЙЗИНГА (ВМ) ДЛЯ МАГАЗИНОВ ОБУВИ И АКСЕССУАРОВ. КАК ПОДНЯТЬ ПРОДАЖИ В МАГАЗИНЕ СРЕДСТВАМИ ВМ?»
              </p>
              <!-- <ul class="hex-content-list">
              <li>Законы коммерческого ВМ для магазинов обуви и аксессуаров; как их применять «под бренд» для максимальных продаж.</li>
              <li>Как создать эффективное зонирование магазина, учитывая структуру ассортимента и аналитику сезонных продаж.</li>
    ...
    <article class="hex-content clearfix">
        <div class="hex-content-left">
            <p class="hex-content-name">Mos Shoes / Mos Pel
            <br/>14 - 17 марта 2017
            <br/>15 марта 14:45-15:45
            </p>
            <div class="hex-content-image">
        ...
        <div class="hex-content-right">
            ...
            <p class="hex-content-description">
                <strong>Семинар Анны Баландиной: </strong>
                <br/>«КАК СОЗДАТЬ ЭФФЕКТИВНЫЙ МАГАЗИН ОБУВИ И АКСЕССУАРОВ И ПРЕЗЕНТОВАТЬ В НЕМ ТОВАР ТАК, ЧТОБЫ ПОКУПАТЕЛЬ НЕ УШЕЛ БЕЗ ПОКУПКИ»
            </p>
            <!-- <ul class="hex-content-list">
            <li>Универсальные решения мерчандайзинга или технологии ВМ «под бренд»? Что сегодня продуктивнее и как это работает? </li>
            <li>Как использовать аналитику ваших продаж для  эффективной презентации товара в зале – «Визуальный мерчандайзинг быстрого реагирования».</li>
            <li>«Эмоциональный мерчандайзинг под бренд» - тренд, которым «болен» Европейский рынок, как перенять не копируя. </li>
            <li>Главные мировые тренды в оформлении магазинов обуви и аксессуаров</li>
            </ul> -->
            <img class="hex-content-logo" src="imgs/logo-mosshoes.png" alt="">
            <img class="hex-content-logo" src="imgs/logo-mospel.png" alt="">
        </div>
    </article>
