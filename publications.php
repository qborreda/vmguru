        ...
        <div class="grid-container">
          ...
          <div class="hor div2">
            ...
            <div class="c-text">
              ...
              <div class="text">
                <p>Люди будут по-прежнему будут предпочитать покупать у людей, а не у роботов. В онлайн бесконечный ассортимент, но нет эмоций от соприкосновения с вещью, да и все эти заморочки с доставкой.</p>
                <!-- <p>Но магазины должны измениться. Не актуальны будут магазины со «статичной картинкой», построил и не меняешь пространство, пока не «износится» оборудование, такого больше не будет.</p> -->
              </div>
            </div>
          </div>
          <div class="hor div3">
