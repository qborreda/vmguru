...
<body class="tmpl-trainings">
    ...
    <div class="short_wrapper">
            ...
            <article class="hex-content clearfix">
                <div class="hex-content-left">
                    <p class="hex-content-name">РАЗРАБОТАКА ДИЗАЙН-ПРОЕКТА
                        <br />ФЛАГМАНСКОГО МАГАЗИНА OSCAR;
                        <br />РАЗРАБОТКА КОНСТРУКТИВОВ ОБОРУДОВАНИЯ</p>
                    <div class="hex-content-image">
                        <img src="/imgs/bkgr_hex_project_oscar_1.jpg" alt="" />
                    </div>
                </div>
                <div class="hex-content-right">
                    <p class="hex-content-name">РАЗРАБОТАКА ДИЗАЙН-ПРОЕКТА
                        <br />ФЛАГМАНСКОГО МАГАЗИНА OSCAR;
                        <br />РАЗРАБОТКА КОНСТРУКТИВОВ ОБОРУДОВАНИЯ</p>
                    <p class="hex-content-description">Включает разработку и визуализацию следующих составляющих:</p>
                    <ul class="hex-content-list">
                        <li>ПРЕ-КОНЦЕПЦИЯ/ ЭСКИЗНЫЙ ПРОЕКТ (в двух вариантах)
                          <ul>
                            <li>Аудит типового магазина, ассорт. структуры коллекций и данных сезонных продаж  для определения оптимального зонирования (приоритет и площадь по линиям) флагмана</li>
                            <li>Общая стилистика торговой концепции </li>
                            <li>Элементы отделки и декорирования (общие предложения )</li>
                        ...
                        <li>ПОЛНЫЙ ДИЗАЙН-ПРОЕКТ
                            <ul>
                                ...
                                <li>Дизайн- проект витрин с разработкой конструктивов внесезонных витринных элементов </li>
                                <li>Дизайн-проект кассовой зоны </li>
                                <li>Дизайн-проект торгового оборудования и зон примерочных; </li>
                                <li>Разработка конструктивов нетипового оборудования</li>
                                <li>Подбор декоративных и  ВМ элементов (манекены, торсы, уникальные деко. элементы, POS материалы)</li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <section class="project-details">
            ...
            <article class="hex-content clearfix">
                <div class="hex-content-left">
                    <p class="hex-content-name">СЕЗОННЫЙ РЕМЕРЧАНДАЙЗИНГ
                        <br />ФЛАГМАНСКОГО МАГАЗИНА И ОБУЧЕНИЕ</p>
                    <div class="hex-content-image">
                        <img src="/imgs/bkgr_hex_project_oscar_2.jpg" alt="" />
                    </div>
                </div>
                <div class="hex-content-right">
                    <p class="hex-content-name">СЕЗОННЫЙ РЕМЕРЧАНДАЙЗИНГ
                    ...
                    <ul class="hex-content-list">
                        <li>Полный ремерчандайзинг торгового зала и витрин</li>
                        <li>Разработка и воплощение сезонной декоративной концепции</li>
                        <li>Разработка/заказ сезонных деко. элементов </li>
                        <li>Стайлинг манекенов, торсов, презентации товара</li>
                        <li>Обучение персонала бренда ВМ стандартам презентации коллекций «под бренд» </li>
                    </ul>
                </div>
            </article>
        ...
        <section class="project-testimonials">
            ...
            <div class="testimonial-text">
                ...
                <p>Среднегодовой прирост продаж в этом магазине относительно других магазинов сети + 20%</p>
